...
static rosidl_typesupport_introspection_c__MessageMember turtle_patrol_interface__srv__Patrol_Response__rosidl_typesupport_introspection_c__Patrol_Response_message_member_array[2] = {
  {
    "success",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtle_patrol_interface__srv__Patrol_Response, messages),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
