...
#include "turtle_patrol_interface/srv/detail/patrol__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtle_patrol_interface::srv::Patrol_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const turtle_patrol_interface::srv::Patrol_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtle_patrol_interface::srv::Patrol_Request *>(
    untyped_ros_message);
...
static size_t _Patrol_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Patrol_Request(full_bounded, is_plain, 0);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_turtle_patrol_interface
const rosidl_message_type_support_t *
get_message_type_support_handle<turtle_patrol_interface::srv::Patrol_Request>()
{
  return &turtle_patrol_interface::srv::typesupport_fastrtps_cpp::_Patrol_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtle_patrol_interface::srv::Patrol_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const turtle_patrol_interface::srv::Patrol_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<turtle_patrol_interface::srv::Patrol_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
static size_t _Patrol_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Patrol_Response(full_bounded, is_plain, 0);
...
{
  return &turtle_patrol_interface::srv::typesupport_fastrtps_cpp::_Patrol_Response__handle;
}
...
{
  return &turtle_patrol_interface::srv::typesupport_fastrtps_cpp::_Patrol__handle;
}
